...
if(isset($_SESSION['admin']) || isset($_SESSION['user'])){
	...
	print '<form class=" border rounded col-md-6 mx-auto px-4" method="POST" action="index.php">';
	print '<img src="../images/profile.png" class="pro mt-3 py-3 mx-auto d-block" title="">';
