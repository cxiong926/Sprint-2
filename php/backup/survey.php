...
print '<form name="surveyForm" class="border rounded col-md-10 mx-auto px-4" onsubmit="return surveyValidate()" id="survey" method="POST" action="action.php">';

print '<div class="form-group row mt-3 mb-2">';
print '<div class="col-sm-4 col-form-label">Email';
print '<p id="emailError" class="mb-0"></p>';
print '</div>';
...
print '<div class="majError col-sm-4">What is your major?';
print '<p id="majorError" class="mb-0"></p>';
print '</div>';
print '<div class="col-sm-8">';
...
print '<div class="col-form-label col-sm-4 pt-0">What grade do you expect to receive in CNMT 310?';
print '<p id="gradeError" class="mb-0"></p>';
print '</div>';
print '<div class="col-sm-8">';
...
print '<fieldset class="form-group">';
print '<div class="row pt-2">';
print '<div class="col-form-label col-sm-4 pt-0">What is your favorite pizza topping?';
print '<p id="toppingError" class="mb-0"></p>';
print '</div>';
print '<div class="col-sm-8">';
...
print '<div class="col text-center" id="error">';
print '</div>';
print '</div>';
