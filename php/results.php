...
if(!$result){
	...
	print '<tbody>';
		...
		foreach ($result as $returnedvalue){
			...
			print '<td class="align-middle"><a href="' . $returnedvalue['buylink'] . '" target="_blank" rel="noopener noreferrer" style="border:none;text-decoration:none"><img src="https://www.niftybuttons.com/amazon/amazon-button3.png"></a></td>';
			print '</tr>';  
		}
